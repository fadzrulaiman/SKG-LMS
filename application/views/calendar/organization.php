...
$(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
        timeFormat: ' ',
        /*Trick to remove the start time of the event*/
        header: {
            left: "",
            center: "title",
            right: ""
    ...
    if (Cookies.get('cal_entity') !== undefined) {
        ...
        selectedEntity = Cookies.get('selected') !== undefined && Cookies.get('selected') == "list" ? false :
            true;
    ...
    $('#lnkICS').click(function() {
        var urlICS = '<?php echo base_url(); ?>ics/entity/<?php echo $user_id; ?>/0/' + $(
            '#chkIncludeChildren').prop('checked');
        if (entity != -1) {
            urlICS = '<?php echo base_url(); ?>ics/entity/<?php echo $user_id; ?>/' + entity + '/' + $(
                '#chkIncludeChildren').prop('checked');
        }
