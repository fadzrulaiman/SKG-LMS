...
<div class="row-fluid">
    <div class="span8">
        ...
        <input type="text" name="duration" id="duration" value="<?php echo intval(set_value('duration')); ?>" <?php echo $this->config->item('disable_edit_leave_duration') ? 'readonly' : ''; ?> disabled />
