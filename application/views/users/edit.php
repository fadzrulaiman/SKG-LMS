        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select name="role[]" multiple="multiple" size="3">
                    ...
                    <?php $selected = (is_array($users_item['role']) && in_array($roles_item['id'], $users_item['role'])) || ($roles_item['id'] == $users_item['role']) ? 'selected' : ''; ?>
                    <option value="<?php echo $roles_item['id'] ?>" <?php echo $selected ?>>
                        <?php echo $roles_item['name'] ?></option>
                    <?php endforeach ?>
                </select>
            </div>
        </div>
            ...
            <div class="controls">
                <select name="contract" id="contract" class="selectized input-xlarge">
                    ...
                    <option value="<?php echo $contract['id'] ?>"
                        <?php if ($contract['id'] == $users_item['contract']) echo "selected"; ?>>
                        <?php echo $contract['name']; ?></option>
                    <?php endforeach ?>
                    <option value="0"
                        <?php if ($users_item['contract'] == 0 || is_null($users_item['contract'])) echo "selected"; ?>>
                        &nbsp;</option>
                </select>
            </div>
        </div>
            ...
            <div class="controls">
                <select name="language">
                    ...
                    <option value="<?php echo $code; ?>"
                        <?php if ($code == $users_item['language']) echo "selected"; ?>><?php echo $language; ?>
                    </option>
                    <?php endforeach ?>
                </select>
            </div>
