...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <table id="counters" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
    ...
    <div class="row">
        <div class="col-12">
            <?php if ($source == 'employees') { ?>
                <a class="btn" href="<?php echo base_url(); ?>entitleddays/contract/<?php echo $contract_id; ?>">
                    <?php echo lang('entitleddays_counters_title_contract'); ?><?php echo $contract_id; ?>
                </a>
                <span class="muted"> (<?php echo $contract_name; ?>)</span>
            <?php } else { ?>
    ...
    <div class="row">
        <div class="col-12">
            <?php if ($source == 'employees') { ?>
                <a class="btn" href="<?php echo base_url(); ?>entitleddays/user/<?php echo $employee_id; ?>">
