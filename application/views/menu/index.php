    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
            <a href="<?php echo base_url();?>home" class="brand">&nbsp;<img
                    ...
                    style="margin-top:-6px;">&nbsp;SKG-LMS</a>
            <div class="nav-responsive">
                <ul class="nav">
                    <li><a href="<?php echo base_url();?>leaves"
                            title="<?php echo lang('menu_leaves_list_requests');?>"><i
                                class="mdi mdi-format-list-bulleted"></i></a></li>

                    <?php if (($is_hr == TRUE) || ($is_admin == TRUE)) { ?>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle"
                            data-toggle="dropdown"><?php echo lang('menu_admin_title');?> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url();?>users"><?php echo lang('menu_admin_list_users');?></a>
                            </li>
                            <li><a
                                    href="<?php echo base_url();?>users/create"><?php echo lang('menu_admin_add_user');?></a>
                            </li>
                            <li class="divider"></li>
                            <li class="nav-header"><?php echo lang('menu_hr_leaves_type_divider');?></li>
                            <li><a
                                    href="<?php echo base_url();?>leavetypes"><?php echo lang('menu_hr_list_leaves_type');?></a>
                            </li>
                            <li class="divider"></li>
                            <li class="nav-header"><?php echo lang('menu_admin_settings_divider');?></li>
                            <li><a
                                    href="<?php echo base_url();?>admin/diagnostic"><?php echo lang('menu_admin_diagnostic');?></a>
                            </li>
                            <?php if ($is_admin == TRUE) { ?>
                            <li><a
                                    href="<?php echo base_url();?>admin/settings"><?php echo lang('menu_admin_settings');?></a>
                            </li>
                            <li><a
                    ...
                    <?php if ($is_hr == TRUE) { ?>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo lang('menu_hr_title');?>
                            <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li class="nav-header"><?php echo lang('menu_hr_employees_divider');?></li>
                            <li><a
                                    href="<?php echo base_url();?>hr/employees"><?php echo lang('menu_hr_list_employees');?></a>
                            </li>
                            <li><a
                                    href="<?php echo base_url();?>organization"><?php echo lang('menu_hr_list_organization');?></a>
                            </li>
                            <li class="divider"></li>
                            <li class="nav-header"><?php echo lang('menu_hr_contracts_divider');?></li>
                            <li><a
                                    href="<?php echo base_url();?>contracts"><?php echo lang('menu_hr_list_contracts');?></a>
                            </li>
                            <li><a
                                    href="<?php echo base_url();?>positions"><?php echo lang('menu_hr_list_positions');?></a>
                            </li>
                            <li><a
                                    href="<?php echo base_url();?>locations"><?php echo lang('menu_hr_list_locations');?></a>
                            </li>
                            <li class="divider"></li>
                            <li class="nav-header"><?php echo lang('menu_hr_setleave_divider');?></li>
                            <li><a
                                    href="<?php echo base_url();?>setleave/setannualleave"><?php echo lang('menu_hr_setleave_annualleave');?></a>
                            </li>
                            <li><a
                            ...
                            <li><a
                                    href="<?php echo base_url();?>reports/leaves"><?php echo lang('menu_hr_report_leaves');?></a>
                            </li>
                            <li><a
                                    href="<?php echo base_url();?>reports/leavesbydate"><?php echo lang('menu_hr_report_leavesbydate');?></a>
                            </li>
                            <li><a
                                    href="<?php echo base_url();?>reports"><?php echo lang('menu_hr_reports_divider');?></a>
                            </li>
                        </ul>
                    </li>
                    <?php } ?>
                ...
                if (($is_manager == TRUE) || ($is_hr == TRUE)) { ?>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle"
                            data-toggle="dropdown"><?php echo lang('menu_requests_title');?> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li class="nav-header"><?php echo lang('menu_requests_leaves');?></li>
                            <li><a
                                    href="<?php echo base_url();?>leaves/counters"><?php echo lang('menu_leaves_counters');?></a>
                            </li>
                            <li><a
                                    href="<?php echo base_url();?>leaves"><?php echo lang('menu_leaves_list_requests');?></a>
                            </li>
                            <li><a
                                    href="<?php echo base_url();?>leaves/create"><?php echo lang('menu_leaves_create_request');?></a>
                            </li>
                            <?php if ($this->config->item('disable_overtime') === FALSE) { ?>
                            <li class="divider"></li>
                            <li class="nav-header"><?php echo lang('menu_requests_overtime');?></li>
                            <li><a
                                    href="<?php echo base_url();?>extra"><?php echo lang('menu_requests_list_extras');?></a>
                            </li>
                            <li><a
                                    href="<?php echo base_url();?>extra/create"><?php echo lang('menu_requests_request_extra');?></a>
                            </li>
                            <?php } ?>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle"
                            data-toggle="dropdown"><?php echo lang('menu_calendar_title');?> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a
                                    href="<?php echo base_url();?>calendar/individual"><?php echo lang('menu_calendar_individual');?></a>
                            </li>
                            <li><a
                                    href="<?php echo base_url();?>calendar/year"><?php echo lang('menu_calendar_year');?></a>
                            </li>
                            ...
                            <li><a
                                    href="<?php echo base_url();?>calendar/tabular"><?php echo lang('menu_calendar_tabular');?></a>
                            </li>
                            <?php } ?>
                        </ul>
                    </li>
                ...
                <ul class="nav pull-right">
                    ...
                    <li><a href="<?php echo base_url();?>users/myprofile"
                            title="<?php echo lang('menu_banner_tip_myprofile');?>"><i
                                class="mdi mdi-account-box-outline"></i></a></li>
                ...
                if ($this->config->item('saml_enabled') === TRUE){
                    ...
                    <li><a href="<?php echo base_url() . $urlLogout;?>"
                            title="<?php echo lang('menu_banner_logout');?>"><i class="mdi mdi-logout"></i></a></li>
                </ul>
            </div>
        </div>
    </div><!-- /.navbar -->
